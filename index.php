...
<html lang="fr">
    <head>
        <meta charset="utf-8">
        <script src="https://kit.fontawesome.com/462b9e339a.js" crossorigin="anonymous"></script>
       <link rel="stylesheet" href="CharleyDemauljean_2_24012021.css">
    ...
    <body>
        <header>
            <div id="nav">
                <a href="#" class="title"><svg width="97" height="45" viewBox="0 0 97 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <nav>
                    <a href="#ancre-H">Hébergements</a>
                    <a href="#ancre-A">Activités</a>
                    <a href="#">S'inscrire</a>
                </nav>
            </div>
            <div id="headerP2">
                ...
                <form action="#" method="POST">
                        <div id="conteneur">
                            <div class="button-L">
                                <label for="ville" ><a href="#"><i class="fas fa-map-marker-alt"></i></a></label>
                            </div>
                            <div id="champ-R">
                                <input type="text" name="ville" id="ville" placeholder="Marseille, France" class="champ-R">
                            </div>
                            <div id="button-R">
                                <input type="submit" value="Rechercher" class="button-R">
                            </div>
                        </div>
                </form>
                <div id="deplacer-filtre">
                    <p id="filt">Filtres</p>
                    <div class="filtres">
                        <div>
                            <a href="#" id="transition1"><i class="fas fa-money-bill-wave"></i>économique</a>
                        </div>
                        <div>
                            <a href="#" id="transition2"><i class="fas fa-child"></i>Familial</a>
                        </div>
                        <div>
                            <a href="#" id="transition3"><i class="fas fa-heart"></i>Romantique</a>
                        </div>
                        <div>
                            <a href="#" id="transition4"><i class="fas fa-dog"></i>Animaux autorisés</a>
                        </div>
                    </div>
                </div>
               <div id="info">
        ...
        <section>
            <div id="big1">
                <div id="heberge-M">
                    <h2 id="ancre-H">Hébergements à Marseille</h2>
                    <div id="main-hotel">
                        <a href="#">
                            <img src="P2_reservia/images/hebergements/small/auberge-cannebiere.jpg" alt="hébergement" class="main-hotel">
                            <div class="under-img">
                                <h3>Auberge la Cannebière</h3>
                                <p>Nuit à partir de <span class="euro">25€</span></p>
                                <div class="stars">
                                    <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><span class="grey"><i class="fas fa-star"></i></span>
                                </div>
                            </div>
                        </a>
                        <a href="#">
                            <img src="P2_reservia/images/hebergements/small/hotel-port.jpg" alt="hébergement" class="main-hotel">
                            <div class="under-img">
                                <h3>Hôtel du port</h3>
                        ...
                        <a href="#">
                            <img src="P2_reservia/images/hebergements/small/mouettes.jpg" alt="hébergement" class="main-hotel">
                            <div class="under-img">
                        ...
                        <a href="#">
                            <img src="P2_reservia/images/hebergements/small/hotel-mer.jpg" alt="hébergement" class="main-hotel">
                            <div class="under-img">
                                <h3>Hôtel de la mer</h3>
                                <p>Nuit à partir de 46<span class="euro">€</span></p>
                                <div class="stars">
                                    <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><span class="grey"><i class="fas fa-star"></i><i class="fas fa-star"></i></span>
                                </div>
                            </div>
                        </a>
                        <a href="#">
                            <img src="P2_reservia/images/hebergements/small/panier.jpg" alt="hébergement" class="main-hotel">
                            <div class="under-img">
                                <h3>Auberge Le Panier</h3>
                                <p>Nuit à partir de <span class="euro">23€</span></p>
                                <div class="stars">
                                    <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><span class="grey"><i class="fas fa-star"></i></span>
                                </div>
                            </div>
                        ...
                        <a href="#">
                            <img src="P2_reservia/images/hebergements/small/amina.jpg" alt="hébergement" class="main-hotel">
                            <div class="under-img">
                                <h3 class="h3">Hôtel chez Amina</h3>
                ...
                <aside>
                    ...
                    <div id="elements-side">
                        <a href="#">
                            <div>
                                <img src="P2_reservia/images/hebergements/small/soleil-matin.jpg" alt="les populaires">
                            </div>
                            <div class="under-side-img">
                        ...
                        <a href="#">
                            <div>
                                <img src="P2_reservia/images/hebergements/small/coeur-de-l'eau.jpg" alt="les populaires">
                            </div>
                            <div class="under-side-img">
                        ...
                        <a href="#">
                            <div>
                                <img src="P2_reservia/images/hebergements/small/bleu-et-blanc.jpg" alt="les populaires">
                            </div>
                            <div class="under-side-img">
            ...
            <div id="big2">
                <h2 id="ancre-A">Activités à Marseille</h2>
                <div id="separate">
                <div id="col1">
                    <a href="#" id="child1">
                        <img src="P2_reservia/images/activites/4_small/vieux-port.jpg" alt="Les Activités" >
                        <h3>Vieux port</h3>
                    </a>
                </div>
                <div id="col2">
                    <a href="#" id="child2">
                        <img src="P2_reservia/images/activites/4_small/pomegues.jpg" alt="Les Activités" >
                        <h3>Fort de Pomègues</h3>
                    </a>
                    <a href="#" id="child3">
                        <img src="P2_reservia/images/activites/4_small/frioul.jpg" alt="Les Activités" >
                        <h3>Îles du Frioul</h3>
                    </a>
                </div>
                <div id="col3">
                    <a href="#" id="child4">
                        <img src="P2_reservia/images/activites/4_small/calanques.jpg" alt="Les Activités" >
                        <h3>Parc National des Calanques</h3>
                    </a>
                </div>
                <div id="col4">
                    <a href="#" id="child5">
                        <img src="P2_reservia/images/activites/4_small/notre-dame.jpg" alt="Les Activités" >
                        <h3>Notre-Dame-de-la-Garde</h3>
                    </a>
                    <a href="#" id="child6">
                        <img src="P2_reservia/images/activites/4_small/longchamp.jpg" alt="Les Activités" >
